...
def main(args=None):
    ...
    # result_map_3 = { "size": list(dds1_map_hz3.keys()), "latency": list(dds1_map_hz3.values())}
    ...
    # title = "String latency comparison of "+ experiment_name + " for same domain Vs different domain" 
    # plt.plot(df1["size"], df1["latency"], color=color_picker(label1_1), marker='.', label = label1_1)
    # plt.plot(df2["size"], df2["latency"], color=color_picker(label1_2), marker='.', label = label1_2)
    # plt.plot(df3["size"], df3["latency"], color=color_picker(label1_3), marker='.', label= label1_3)
    # plt.plot(df4["size"], df4["latency"], color=color_picker(label2_1), marker='.', label = label2_1)
    # plt.plot(df5["size"], df5["latency"], color=color_picker(label2_2), marker='.', label = label2_2)
    # plt.plot(df6["size"], df6["latency"], color=color_picker(label2_3), marker='.', label= label2_3)
    # plt.plot(df7["size"], df7["latency"], color=color_picker(label3_1), marker='.', label = label3_1)
    # plt.plot(df8["size"], df8["latency"], color=color_picker(label3_2), marker='.', label = label3_2)
    # plt.plot(df9["size"], df9["latency"], color=color_picker(label3_3), marker='.', label= label3_3)
    # plt.title(title)
    ...
    plt.title('Different DDS string latency comparison for '+ experiment_name + " for frequency- " + hz1 +" " + hz2 + " " + hz3)
