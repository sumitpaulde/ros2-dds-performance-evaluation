...
image_latency_path_different_domain = sys.argv[3]
image_latency_path_same_domain = sys.argv[4]
dds_name = sys.argv[5]
hz1= sys.argv[6]
hz2= sys.argv[7]
hz3= sys.argv[8]
...
def main(args=None):
    ...
    different_domain_rtt = prepare_binary_file_rtt(image_latency_path_different_domain)
    ...
    same_domain_rtt = prepare_binary_file_rtt(image_latency_path_same_domain)
    ...
    plt.title('Same Domain Vs Different Domain binary latency comparison for '+ dds_name + " for frequency- " + hz1 +" " + hz2 + " " + hz3)
    plt.legend()
    plt.show()
